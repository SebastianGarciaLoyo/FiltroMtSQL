...
('Mariza Lopez', 'maria.lopez@example.com', '123-456-7891', '2024-01-05'),
('Carlos Mendoza', 'carlos.mendoza@example.com', '123-456-7892', '2024-02-10'),
('Ana Gonzàlez', 'ana.gonzalez@example.com', '123-456-7893', '2024-02-20'),
('Luis Torres', 'luis.torres@example.com', '123-456-7894', '2024-03-05'),
('Laura Rivera', 'laura.rivera@example.com','123-456-7895', '204-03-15'),
('Fernando Garcìa', 'fernando.garcia@example.com', '123-456-7896', '2024-04-20'),
('Isabel Fernàndez', 'isabel.fernandez@example.com', '123-456-7897', '2024-04-25'),
('Ricardo Morales', 'ricardo.morales@example.com', '123-456-7898', '2024-05-01'),
('Lucìa Martìnez', 'licua.martinez@example.com', '123-456-7899', '2024-05-05'),
('Santiago Jimènez', 'santiago.jimenez@example.com', '123-456-7900', '2024-05-10'),
('Patricia Romero', 'patricia.romero@example.com', '123-456-7901', '2024-05-10');

-- insertando datos en la tabla menu
...
insert into detallespedido(id_pedido, id_menu, cantidad, precio_unitario) values
(1,1,1, 12.50),
(1,3,1, 25.00),
(1,6,3, 3.00),
(2,2,1, 8.75),
